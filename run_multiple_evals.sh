...
folder_names="OurMasking_1399 MagViT_masking_1399 MaskViT_masking_1399 Wanhee_masking_1399 OurMasking_1699 MagViT_masking_1699 MaskViT_masking_1699 Wanhee_masking_1699 OurMasking_1999 MagViT_masking_1999 MaskViT_masking_1999 Wanhee_masking_1999 Wanhee_masking_physion_3299"

for folder_name in $folder_names; do
  cmd="python LR_scikit.py --model-type logistic --data-path $exp_dir/$folder_name/train_features.hdf5 --data-type $folder_name --test-path $exp_dir/$folder_name/test_features.hdf5 --scenario-name observed --train-scenario-indices $exp_dir/$folder_name/train_json.json --test-scenario-indices $exp_dir/$folder_name/test_json.json --scenario features --test-scenario-map /ccn2/u/thekej/R3M_readout/test_map.json --one-scenario all"
  echo $cmd
  eval $cmd
done