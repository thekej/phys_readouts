...
model_save_name="DFM_re10k"
model_name="physion_model.DFM_re10k"
gpu='0,1,2,3,4,5,6,7'
save_dir="/ccn2/u/thekej/models/"
mode="ocd"
data_root_path="/ccn2/u/rmvenkat/data/testing_physion/regenerate_from_old_commit/"
cmd="physion_feature_extract --model_save_name $model_save_name --model $model_name --gpu $gpu --dir_for_saving $save_dir --mode $mode --data_root_path $data_root_path --model_path /ccn2/u/rmvenkat/data/dfm_weights/re10k_model.pt"
echo $cmd
eval "$cmd"
