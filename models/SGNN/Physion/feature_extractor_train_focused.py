...
print('save 4')
with h5py.File('/ccn2/u/thekej/models/sgnn_physion/sim_focussed_tester/train_features.hdf5' ,'w') as hf:
...
with open('/ccn2/u/thekej/models/sgnn_physion/sim_focussed_tester/train_json.json', 'w') as f:
    json.dump(all_scenarios, f)
    
with open('/ccn2/u/thekej/models/sgnn_physion/sim_focussed_tester/train_scenario_map.json', 'w') as f:
